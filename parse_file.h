...
/*Function opens source file, reads line by line from a file, makes first typo errors checks, if ok passes further for checking*/
...
/*Function receives a line and linked lists for saving data. Splits line to words, checks type of command and if operands are legal for given command. */
